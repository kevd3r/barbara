...
<div class="ego row m-auto">
  <h1 class="ego-title my-5 text-center">Pour quoi ?</h1>
  <div class="row justify-content-center">
    ...
    <div class="ego-text col-lg-7 col-sm-12 my-auto">
      ...
      <div class="ego-big-text">
        ...
        <h2 class="p-0 m-0">De l'ombre à la lumière</h2>
        <h2 class="p-0 m-0">De la complexité à la simplicité</h2>
      </div>
    </div>
    ...
    <div class="ego-text col-lg-7 col-sm-12 my-auto">
      ...
      <div class="ego-big-text">
        <h2 class="p-0 m-0">Se déployer</h2>
